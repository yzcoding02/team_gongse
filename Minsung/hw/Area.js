...
console.log("공식: side**2*6")
console.log("입력은 3")
console.log(areaSurfaceCube(3))

console.log("구 겉넓이")
console.log("공식: 4 * pi * r**2")
console.log("입력은 3")
console.log(surfaceAreaSphere(3))

console.log("직사각형 넓이")
console.log("공식:width * length")
console.log("입력은 3,4")
...
console.log("삼각형 넓이")
console.log("공식:(base * height) / 2.0")
console.log("입력은 3,4")
console.log(areaTriangle(3, 4))

console.log("평행사변형 넓이")
console.log("공식:base * height")
console.log("입력은 3,4")
console.log(areaParallelogram(3, 4))

console.log("사다리꼴 넓이")
console.log("공식:(1 / 2) * (base1 + base2) * height ")
console.log("입력은 3,4,5")
console.log(areaTrapezium(3, 4, 5))

console.log("원 넓이")
console.log("공식:Math.PI * radius ** 2")
console.log("입력은 3")
console.log(areaTrapezium(3))

console.log("마틈모 넓이")
console.log("공식:(1 / 2) * diagonal1 * diagonal2")
console.log("입력은 3,4")
...
console.log("입력은 3,4")
console.log(areaTriangleWithAllThreeSides(3, 4))