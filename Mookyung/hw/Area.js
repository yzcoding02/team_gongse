...
console.log("정육면체 겉넓이")
console.log("공식:side ** 2 x 6")
console.log("입력은 3")
console.log(surfaceAreaCube(3))
console.log("구 겉넓이")
console.log("공식:4 x pi x r ** 2")
console.log("입력은 3")
console.log(surfaceAreaSphere(3))
console.log("직사각형 넓이")
console.log("공식:width x length")
console.log("입력은 3,4")
console.log(areaRectangle(3, 4))
console.log("정사각형 넓이")
console.log("공식:side ** 2")
console.log("입력은 3")
console.log(areaSquare(3))
console.log("삼각형 넓이")
console.log("공식:(base x height) / 2")
console.log("입력은 3,4")
console.log(areaTriangle(3, 4))
console.log("세 변의 길이를 알때의 삼각형 넓이")
console.log("공식:(side1 + side2 + side3) / 2")
console.log("입력은 3,4,5")
console.log(areaTriangleWithAllThreeSides(3, 4, 5))
console.log("평행사변형 넓이")
console.log("공식:base x height")
console.log("입력은 3,4")
console.log(areaParallelogram(3, 4))
console.log("사다리꼴 넓이")
console.log("공식:(1 / 2) x (base1 + base2) x height")
console.log("입력은 3,4,5")
console.log(areaTrapezium(3, 4, 5))
console.log("원 넓이")
console.log("공식:Math.PI x radius ** 2")
console.log("입력은 3")
console.log(areaCircle(3))
console.log("마름모 넓이")
console.log("공식:(1 / 2) x diagonal1 x diagonal2")
console.log("입력은 3,4")
console.log(areaRhombus(3, 4))